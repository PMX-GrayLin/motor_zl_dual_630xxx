...
#define M2_BUS_VOLTAGE_Pin GPIO_PIN_1
#define M2_BUS_VOLTAGE_GPIO_Port GPIOC
#define M2_TEMPERATURE_Pin GPIO_PIN_2
#define M2_TEMPERATURE_GPIO_Port GPIOC
#define M2_HALL_H1_Pin GPIO_PIN_0
#define M2_HALL_H1_GPIO_Port GPIOA
#define M2_HALL_H2_Pin GPIO_PIN_1
#define M2_HALL_H2_GPIO_Port GPIOA
#define M1_OPAMP1_OUT_Pin GPIO_PIN_2
#define M1_OPAMP1_OUT_GPIO_Port GPIOA
#define M1_CURR_SHUNT_Pin GPIO_PIN_3
#define M1_CURR_SHUNT_GPIO_Port GPIOA
#define M2_OPAMP2_EXT_GAIN_Pin GPIO_PIN_5
#define M2_OPAMP2_EXT_GAIN_GPIO_Port GPIOA
#define M2_OPAMP2_OUT_Pin GPIO_PIN_6
#define M2_OPAMP2_OUT_GPIO_Port GPIOA
#define M2_CURR_SHUNT_Pin GPIO_PIN_7
#define M2_CURR_SHUNT_GPIO_Port GPIOA
#define M1_OPAMP1_EXT_GAIN_Pin GPIO_PIN_5
#define M1_OPAMP1_EXT_GAIN_GPIO_Port GPIOC
...
#define M2_HALL_H3_Pin GPIO_PIN_10
...
#define M2_PWM_UH_Pin GPIO_PIN_15
#define M2_PWM_UH_GPIO_Port GPIOA
...
#define M2_DP_Pin GPIO_PIN_6
#define M2_DP_GPIO_Port GPIOB
#define M2_PWM_EN_UVW_Pin GPIO_PIN_7
#define M2_PWM_EN_UVW_GPIO_Port GPIOB
#define M2_PWM_VH_Pin GPIO_PIN_8
#define M2_PWM_VH_GPIO_Port GPIOB
#define M2_PWM_WH_Pin GPIO_PIN_9
#define M2_PWM_WH_GPIO_Port GPIOB
