...
#define configurationFlag1_M2     (VBUS_SENSING_FLAG|TEMP_SENSING_FLAG)
#define configurationFlag2_M2     (0U)

#define DRIVE_TYPE_M2              0
#define PRIM_SENSOR_M2            EHALL
#define AUX_SENSOR_M2             ENO_SENSOR
#define TOPOLOGY_M2               2
#define FOC_RATE_M2               1
#define PWM_FREQ_M2               16000
