...
static void MX_TIM2_Init(void)
{
  ...
  htim2.Init.Period = M2_HALL_TIM_PERIOD;
...
static void MX_TIM8_Init(void)
{
  ...
  sConfigOC.OCMode = TIM_OCMODE_PWM1;
  sConfigOC.Pulse = ((PWM_PERIOD_CYCLES2) / 4);
  sConfigOC.OCPolarity = TIM_OCPOLARITY_HIGH;
  sConfigOC.OCNPolarity = TIM_OCNPOLARITY_HIGH;
  sConfigOC.OCFastMode = TIM_OCFAST_DISABLE;
  sConfigOC.OCIdleState = TIM_OCIDLESTATE_RESET;
  ...
  sConfigOC.Pulse = (((PWM_PERIOD_CYCLES2) / 2) + 1);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(M2_PWM_EN_UVW_GPIO_Port, M2_PWM_EN_UVW_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : M2_PWM_EN_UVW_Pin */
  GPIO_InitStruct.Pin = M2_PWM_EN_UVW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(M2_PWM_EN_UVW_GPIO_Port, &GPIO_InitStruct);
