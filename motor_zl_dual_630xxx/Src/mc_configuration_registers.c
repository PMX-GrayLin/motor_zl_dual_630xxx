...
const char_t CTL_BOARD[] = "EVSPIN32G4-DUAL";
static const char_t M1_PWR_BOARD[] = "EVSPIN32G4-DUAL";
...
const char_t M2_PWR_BOARD[] = "EVSPIN32G4-DUAL";
