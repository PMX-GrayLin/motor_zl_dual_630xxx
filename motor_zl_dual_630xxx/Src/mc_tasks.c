...
#define M2_CHARGE_BOOT_CAP_DUTY_CYCLES ((uint32_t)0.000\
...
{
LL_GPIO_LockPin(M2_DP_GPIO_Port, M2_DP_Pin);
...
LL_GPIO_LockPin(M2_PWM_EN_UVW_GPIO_Port, M2_PWM_EN_UVW_Pin);
...
LL_GPIO_LockPin(M2_CURR_SHUNT_GPIO_Port, M2_CURR_SHUNT_Pin);
LL_GPIO_LockPin(M1_CURR_SHUNT_GPIO_Port, M1_CURR_SHUNT_Pin);
...
LL_GPIO_LockPin(M2_OPAMP2_OUT_GPIO_Port, M2_OPAMP2_OUT_Pin);
LL_GPIO_LockPin(M2_OPAMP2_EXT_GAIN_GPIO_Port, M2_OPAMP2_EXT_GAIN_Pin);
