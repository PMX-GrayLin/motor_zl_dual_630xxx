...
uint8_t RI_SetRegisterMotor2(uint16_t regID, uint8_t typeID, uint8_t *data, uint16_t *size, int16_t dataAvailable)
{
  uint8_t retVal = MCP_CMD_OK;
  uint8_t motorID=1;
  MCI_Handle_t *pMCIN = &Mci[motorID];
  ...
  switch(typeID)
  {
    ...
    case TYPE_DATA_16BIT:
    {
      ...
      switch (regID)
      {
        case MC_REG_SPEED_KP:
        {
          PID_SetKP(&PIDSpeedHandle_M2, (int16_t)regdata16);
          break;
        }

        case MC_REG_SPEED_KI:
        {
          PID_SetKI(&PIDSpeedHandle_M2, (int16_t)regdata16);
          break;
        }

        case MC_REG_SPEED_KD:
        {
          PID_SetKD(&PIDSpeedHandle_M2, (int16_t)regdata16);
          break;
        }

        case MC_REG_I_Q_KP:
        {
          PID_SetKP(&PIDIqHandle_M2, (int16_t)regdata16);
          break;
        }

        case MC_REG_I_Q_KI:
        {
          PID_SetKI(&PIDIqHandle_M2, (int16_t)regdata16);
          break;
        }

        case MC_REG_I_Q_KD:
        {
          PID_SetKD(&PIDIqHandle_M2, (int16_t)regdata16);
          break;
        }

        case MC_REG_I_D_KP:
        {
          PID_SetKP(&PIDIdHandle_M2, (int16_t)regdata16);
          break;
        }

        case MC_REG_I_D_KI:
        {
          PID_SetKI(&PIDIdHandle_M2, (int16_t)regdata16);
          break;
        }

        case MC_REG_I_D_KD:
        {
          PID_SetKD(&PIDIdHandle_M2, (int16_t)regdata16);
          break;
        }
        ...
        case MC_REG_SPEED_KP_DIV:
        {
          PID_SetKPDivisorPOW2(&PIDSpeedHandle_M2, regdata16);
          break;
        }

        case MC_REG_SPEED_KI_DIV:
        {
          PID_SetKIDivisorPOW2(&PIDSpeedHandle_M2, regdata16);
          break;
        }

        case MC_REG_SPEED_KD_DIV:
        {
          PID_SetKDDivisorPOW2(&PIDSpeedHandle_M2, regdata16);
          break;
        }

        case MC_REG_I_D_KP_DIV:
        {
          PID_SetKPDivisorPOW2(&PIDIdHandle_M2, regdata16);
          break;
        }

        case MC_REG_I_D_KI_DIV:
        {
          PID_SetKIDivisorPOW2(&PIDIdHandle_M2, regdata16);
          break;
        }

        case MC_REG_I_D_KD_DIV:
        {
          PID_SetKDDivisorPOW2(&PIDIdHandle_M2, regdata16);
          break;
        }

        case MC_REG_I_Q_KP_DIV:
        {
          PID_SetKPDivisorPOW2(&PIDIqHandle_M2, regdata16);
          break;
        }

        case MC_REG_I_Q_KI_DIV:
        {
          PID_SetKIDivisorPOW2(&PIDIqHandle_M2, regdata16);
          break;
        }

        case MC_REG_I_Q_KD_DIV:
        {
          PID_SetKDDivisorPOW2(&PIDIqHandle_M2, regdata16);
          break;
        }
...
uint8_t RI_GetRegisterGlobal(uint16_t regID,uint8_t typeID,uint8_t * data,uint16_t *size,int16_t freeSpace){
  ...
  uint8_t RI_GetRegisterMotor2(uint16_t regID,uint8_t typeID,uint8_t * data,uint16_t *size,int16_t freeSpace) {
    uint8_t retVal = MCP_CMD_OK;
    uint8_t motorID=1;
    MCI_Handle_t *pMCIN = &Mci[motorID];
    BusVoltageSensor_Handle_t* BusVoltageSensor= &BusVoltageSensor_M2._Super;
    switch (typeID)
    {
      case TYPE_DATA_8BIT:
      {
      ...
      case TYPE_DATA_16BIT:
      {
        ...
        if (freeSpace >= 2)
        {
          switch (regID)
          {
            case MC_REG_SPEED_KP:
            {
              *regdata16 = PID_GetKP(&PIDSpeedHandle_M2);
              break;
            }

            case MC_REG_SPEED_KI:
            {
              *regdata16 = PID_GetKI(&PIDSpeedHandle_M2);
              break;
            }

            case MC_REG_SPEED_KD:
            {
              *regdata16 = PID_GetKD(&PIDSpeedHandle_M2);
              break;
            }

            case MC_REG_I_Q_KP:
            {
              *regdata16 = PID_GetKP(&PIDIqHandle_M2);
              break;
            }

            case MC_REG_I_Q_KI:
            {
              *regdata16 = PID_GetKI(&PIDIqHandle_M2);
              break;
            }

            case MC_REG_I_Q_KD:
            {
              *regdata16 = PID_GetKD(&PIDIqHandle_M2);
              break;
            }

            case MC_REG_I_D_KP:
            {
              *regdata16 = PID_GetKP(&PIDIdHandle_M2);
              break;
            }

            case MC_REG_I_D_KI:
            {
              *regdata16 = PID_GetKI(&PIDIdHandle_M2);
              break;
            }

            case MC_REG_I_D_KD:
            {
              *regdata16 = PID_GetKD(&PIDIdHandle_M2);
              break;
            }
            ...
            case MC_REG_HEATS_TEMP:
            {
              *regdata16 = NTC_GetAvTemp_C(&TempSensor_M2);
              break;
            }
            ...
            {
              //cstat !MISRAC2012-Rule-11.3
              *regdata16 = SPD_GetElAngle ((SpeednPosFdbk_Handle_t*) &HALL_M2);
              break;
            }
            ...
            {
              //cstat !MISRAC2012-Rule-11.3
              *regdata16 = SPD_GetS16Speed ((SpeednPosFdbk_Handle_t*) &HALL_M2);
              break;
            }
            ...
            case MC_REG_SPEED_KP_DIV:
            {
              *regdataU16 = (uint16_t)PID_GetKPDivisorPOW2(&PIDSpeedHandle_M2);
              break;
            }

            case MC_REG_SPEED_KI_DIV:
            {
              *regdataU16 = (uint16_t)PID_GetKIDivisorPOW2(&PIDSpeedHandle_M2);
              break;
            }

            case MC_REG_SPEED_KD_DIV:
            {
              *regdataU16 = PID_GetKDDivisorPOW2(&PIDSpeedHandle_M2);
              break;
            }
            case MC_REG_I_D_KP_DIV:
            {
              *regdataU16 = PID_GetKPDivisorPOW2(&PIDIdHandle_M2);
              break;
            }

            case MC_REG_I_D_KI_DIV:
            {
              *regdataU16 = PID_GetKIDivisorPOW2(&PIDIdHandle_M2);
              break;
            }

            case MC_REG_I_D_KD_DIV:
            {
              *regdataU16 = PID_GetKDDivisorPOW2(&PIDIdHandle_M2);
              break;
            }

            case MC_REG_I_Q_KP_DIV:
            {
              *regdataU16 = PID_GetKPDivisorPOW2(&PIDIqHandle_M2);
              break;
            }

            case MC_REG_I_Q_KI_DIV:
            {
              *regdataU16 = PID_GetKIDivisorPOW2(&PIDIqHandle_M2);
              break;
            }

            case MC_REG_I_Q_KD_DIV:
            {
              *regdataU16 = PID_GetKDDivisorPOW2(&PIDIqHandle_M2);
              break;
            }
      ...
      case TYPE_DATA_32BIT:
      {
        ...
        if (freeSpace >= 4)
        {
          switch (regID)
          {
            ...
            {
              FloatToU32 ReadVal; //cstat !MISRAC2012-Rule-19.2
              ReadVal.Float_Val = PQD_GetAvrgElMotorPowerW(pMPM[M2]);
              *regdataU32 = ReadVal.U32_Val; //cstat !UNION-type-punning
              break;
            }
        ...
        switch (regID)
        {
          ...
          case MC_REG_SCALE_CONFIG:
          {
            *rawSize = 12;
            ...
            {
              memcpy(rawData, &scaleParams_M2, sizeof(ScaleParams_t) );
            }
            break;
          }
          case MC_REG_SPEED_RAMP:
...
__weak uint8_t RI_GetPtrReg(uint16_t dataID, void **dataPtr)
{
  ...
  uint8_t (*GetPtrRegFcts[NBR_OF_MOTORS])(uint16_t, void**) = {&RI_GetPtrRegMotor1, &RI_GetPtrRegMotor2};

  retVal = GetPtrRegFcts[motorID](dataID, dataPtr);

  return(retVal);
}
__weak uint8_t RI_GetPtrRegMotor1(uint16_t dataID, void **dataPtr)
{
...
__weak uint8_t RI_GetPtrRegMotor2(uint16_t dataID, void **dataPtr)
{
    ...
    switch (typeID)
    {
      case TYPE_DATA_16BIT:
      {
        switch (regID)
        {
          ...
          case MC_REG_HALL_SPEED:
          {
            *dataPtr = &((&HALL_M2)->_Super.hAvrMecSpeedUnit);
            break;
          }

          case MC_REG_HALL_EL_ANGLE:
          {
            *dataPtr = &((&HALL_M2)->_Super.hElAngle);
            break;
          }
