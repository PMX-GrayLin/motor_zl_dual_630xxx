...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB1     ------> ADC1_IN12
    */
    GPIO_InitStruct.Pin = M1_TEMPERATURE_Pin|M2_BUS_VOLTAGE_Pin|M2_TEMPERATURE_Pin;
  ...
  */
    ...
    PA6     ------> ADC2_IN3
    */
    GPIO_InitStruct.Pin = M2_OPAMP2_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(M2_OPAMP2_OUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN12
    */
    HAL_GPIO_DeInit(GPIOC, M1_TEMPERATURE_Pin|M2_BUS_VOLTAGE_Pin|M2_TEMPERATURE_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(M2_OPAMP2_OUT_GPIO_Port, M2_OPAMP2_OUT_Pin);
...
void HAL_COMP_MspInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP2_MspInit 0 */
    ...
    PA7     ------> COMP2_INP
    */
    GPIO_InitStruct.Pin = M2_CURR_SHUNT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(M2_CURR_SHUNT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP2_MspDeInit 0 */
    ...
    PA7     ------> COMP2_INP
    */
    HAL_GPIO_DeInit(M2_CURR_SHUNT_GPIO_Port, M2_CURR_SHUNT_Pin);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspInit 0 */
    ...
    PC5     ------> OPAMP1_VINM
    */
    GPIO_InitStruct.Pin = M1_OPAMP1_OUT_Pin|M1_CURR_SHUNT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(M1_OPAMP1_EXT_GAIN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END OPAMP2_MspInit 0 */
    ...
    PA7     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = M2_OPAMP2_EXT_GAIN_Pin|M2_OPAMP2_OUT_Pin|M2_CURR_SHUNT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PC5     ------> OPAMP1_VINM
    */
    HAL_GPIO_DeInit(GPIOA, M1_OPAMP1_OUT_Pin|M1_CURR_SHUNT_Pin);

    HAL_GPIO_DeInit(M1_OPAMP1_EXT_GAIN_GPIO_Port, M1_OPAMP1_EXT_GAIN_Pin);
  ...
  /* USER CODE END OPAMP2_MspDeInit 0 */
    ...
    PA7     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(GPIOA, M2_OPAMP2_EXT_GAIN_Pin|M2_OPAMP2_OUT_Pin|M2_CURR_SHUNT_Pin);
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    PB6     ------> TIM8_BKIN2
    */
    GPIO_InitStruct.Pin = M2_DP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF10_TIM8;
    HAL_GPIO_Init(M2_DP_GPIO_Port, &GPIO_InitStruct);

    /* TIM8 DMA Init */
    /* TIM8_CH4 Init */
    hdma_tim8_ch4.Instance = DMA2_Channel1;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(M2_PWM_UH_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PB9     ------> TIM8_CH3
    */
    HAL_GPIO_DeInit(M2_PWM_UH_GPIO_Port, M2_PWM_UH_Pin);

    HAL_GPIO_DeInit(GPIOB, M2_DP_Pin|M2_PWM_VH_Pin|M2_PWM_WH_Pin);
